<footer class="footer  text-center pt-3 fixed-bottom">
    ...
    <div class="row align-items-center justify-content-lg-between">
      ...
      <div class="col-lg-6 mx-auto">
        <ul class="nav nav-footer  text-center ">
          <li class="nav-item">© 2022 ADSI - 2278769</li>
          <li class="nav-item">
...
<script src="<?php echo URLROOT; ?>js/argon-dashboard.min.js?v=2.0.4"></script>
